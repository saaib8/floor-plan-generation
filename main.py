...
from generation import generate_product_placement
from models import GenerationRequest, GenerationStartResponse, GenerationStatusResponse
...
def _run_generation(gen_id, highlight_path, products, presets, room_dimensions, generation_type):
    try:
        result_bytes = generate_product_placement(
